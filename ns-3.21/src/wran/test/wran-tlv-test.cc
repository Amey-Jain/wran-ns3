...
/*
 * Test the wran tlv implementation.
 */
class Ns3WranCsParamTlvTestCase : public TestCase
{
public:
  Ns3WranCsParamTlvTestCase ();
  virtual ~Ns3WranCsParamTlvTestCase ();
...
Ns3WranCsParamTlvTestCase::Ns3WranCsParamTlvTestCase ()
...
void
Ns3WranCsParamTlvTestCase::DoRun (void)
{
 ...
 */
class Ns3WranSfTlvTestCase : public TestCase
{
public:
  Ns3WranSfTlvTestCase ();
  virtual ~Ns3WranSfTlvTestCase ();
...
Ns3WranSfTlvTestCase::Ns3WranSfTlvTestCase ()
...
void
Ns3WranSfTlvTestCase::DoRun (void)
{
...
// ==============================================================================
class Ns3WranTlvTestSuite : public TestSuite
{
public:
  Ns3WranTlvTestSuite ();
};

Ns3WranTlvTestSuite::Ns3WranTlvTestSuite ()
  : TestSuite ("wran-tlv", UNIT)
{
  AddTestCase (new Ns3WranCsParamTlvTestCase, TestCase::QUICK);
  AddTestCase (new Ns3WranSfTlvTestCase, TestCase::QUICK);
}

static Ns3WranTlvTestSuite ns3WranTlvTestSuite;
