...
#include "ns3/wran-connection.h"
#include <iostream>

using namespace ns3;

/*
 * Test the wran packet fragmentation.
 */
class Ns3WranFragmentationTestCase : public TestCase
{
public:
  Ns3WranFragmentationTestCase ();
  virtual ~Ns3WranFragmentationTestCase ();
...
Ns3WranFragmentationTestCase::Ns3WranFragmentationTestCase ()
...
void
Ns3WranFragmentationTestCase::DoRun (void)
{
  ...
  Cid cid;
  WranConnection *connectionTx = new WranConnection (cid, Cid::TRANSPORT);
  WranConnection *connectionRx = new WranConnection (cid, Cid::TRANSPORT);
...
// *** send packet -----> receive packet ----**
      ...
      if (fc != 2)
      ...
      else
        {
          ...
          connectionRx->FragmentEnqueue (fragment);
          WranConnection::FragmentsQueue fragmentsQueue = connectionRx->GetFragmentsQueue ();
...
class Ns3WranFragmentationTestSuite : public TestSuite
{
public:
  Ns3WranFragmentationTestSuite ();
};

Ns3WranFragmentationTestSuite::Ns3WranFragmentationTestSuite ()
  : TestSuite ("wran-fragmentation", UNIT)
{
  AddTestCase (new Ns3WranFragmentationTestCase, TestCase::QUICK);
}

static Ns3WranFragmentationTestSuite ns3WranFragmentationTestSuite;
