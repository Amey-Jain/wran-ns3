...
class Ns3WranSchedulingTestCase : public TestCase
{
public:
  Ns3WranSchedulingTestCase ();
  virtual ~Ns3WranSchedulingTestCase ();

private:
  virtual void DoRun (void);
  bool DoRunOnce (WranHelper::SchedulerType scheduler);

};

Ns3WranSchedulingTestCase::Ns3WranSchedulingTestCase ()
...
bool
Ns3WranSchedulingTestCase::DoRunOnce (WranHelper::SchedulerType scheduler)
{
  ...
  ssDevs.Get (1)->GetObject<SubscriberStationNetDevice> ()->SetModulationType (WranPhy::MODULATION_TYPE_QAM16_12);
...
void
Ns3WranSchedulingTestCase::DoRun ()
{
  if (DoRunOnce (WranHelper::SCHED_TYPE_SIMPLE) == true)
    {
      return;
    }
  if (DoRunOnce (WranHelper::SCHED_TYPE_RTPS) == true)
    {
      return;
    }
}
...
// =============================================================================
class Ns3WranSFTypeTestCase : public TestCase
{
public:
  Ns3WranSFTypeTestCase ();
  virtual ~Ns3WranSFTypeTestCase ();
...
Ns3WranSFTypeTestCase::Ns3WranSFTypeTestCase ()
...
bool
Ns3WranSFTypeTestCase::DoRunOnce (ServiceFlow::SchedulingType schedulingType)
{
  NodeContainer ssNodes;
  NodeContainer bsNodes;
  ssNodes.Create (2);
  ...
  IpcsClassifierRecord DlClassifier (Ipv4Address ("0.0.0.0"),
                                     ...
                                     17,
                                     1);
  ServiceFlow DlServiceFlow = wran.CreateServiceFlow (ServiceFlow::SF_DIRECTION_DOWN, schedulingType, DlClassifier);
  IpcsClassifierRecord UlClassifier (SSinterfaces.GetAddress (1),
                                     ...
                                     17,
                                     1);
  ServiceFlow UlServiceFlow = wran.CreateServiceFlow (ServiceFlow::SF_DIRECTION_UP, schedulingType, UlClassifier);
...
class Ns3WranQoSTestSuite : public TestSuite
{
public:
  Ns3WranQoSTestSuite ();
};

Ns3WranQoSTestSuite::Ns3WranQoSTestSuite ()
  : TestSuite ("wran-qos", SYSTEM)
{
  AddTestCase (new Ns3WranSFTypeTestCase, TestCase::QUICK);
  AddTestCase (new Ns3WranSchedulingTestCase, TestCase::QUICK);
}

static Ns3WranQoSTestSuite ns3WranQoSTestSuite;
