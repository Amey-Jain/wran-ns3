...
NS_LOG_COMPONENT_DEFINE ("WranUplinkSchedulerSimple");

namespace ns3 {
NS_OBJECT_ENSURE_REGISTERED (WranUplinkSchedulerSimple);

WranUplinkSchedulerSimple::WranUplinkSchedulerSimple (void)
{
  SetBs (0);
...
WranUplinkSchedulerSimple::WranUplinkSchedulerSimple (Ptr<WranBaseStationNetDevice> bs)
{
  SetBs (bs);
  SetTimeStampIrInterval (Seconds (0));
  SetNrIrOppsAllocated (0);
...
void
WranUplinkSchedulerSimple::InitOnce ()
{

}

TypeId
WranUplinkSchedulerSimple::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::WranUplinkSchedulerSimple").SetParent<Object> ();
  return tid;
}

std::list<OfdmUlMapIe>
WranUplinkSchedulerSimple::GetUplinkAllocations (void) const
{
  return m_uplinkAllocations;
}

void
WranUplinkSchedulerSimple::GetChannelDescriptorsToUpdate (bool &updateDcd,
                                                      bool &updateUcd,
                                                      bool &sendDcd,
                                                      bool &sendUcd)
{
...
uint32_t
WranUplinkSchedulerSimple::CalculateAllocationStartTime (void)
{
  return GetBs ()->GetNrDlSymbols () * GetBs ()->GetPhy ()->GetPsPerSymbol () + GetBs ()->GetTtg ();
}

void
WranUplinkSchedulerSimple::AddUplinkAllocation (OfdmUlMapIe &ulMapIe,
...
void
WranUplinkSchedulerSimple::Schedule (void)
{
  m_uplinkAllocations.clear ();
  SetIsIrIntrvlAllocated (false);
  SetIsInvIrIntrvlAllocated (false);
...
void
WranUplinkSchedulerSimple::ServiceUnsolicitedGrants (const WranSSRecord *ssRecord,
...
void
WranUplinkSchedulerSimple::ServiceBandwidthRequests (const WranSSRecord *ssRecord,
                                                 enum WranServiceFlow::SchedulingType schedulingType,
                                                 OfdmUlMapIe &ulMapIe,
                                                 const WranPhy::ModulationType modulationType,
                                                 uint32_t &symbolsToAllocation,
...
bool
WranUplinkSchedulerSimple::ServiceBandwidthRequests (WranServiceFlow *serviceFlow,
                                                 enum WranServiceFlow::SchedulingType schedulingType,
                                                 OfdmUlMapIe &ulMapIe,
                                                 const WranPhy::ModulationType modulationType,
                                                 uint32_t &symbolsToAllocation,
...
void
WranUplinkSchedulerSimple::AllocateInitialRangingInterval (uint32_t &symbolsToAllocation, uint32_t &availableSymbols)
{
...
void
WranUplinkSchedulerSimple::SetupWranServiceFlow (WranSSRecord *ssRecord, WranServiceFlow *serviceFlow)
{
...
void
WranUplinkSchedulerSimple::ProcessBandwidthRequest (const BandwidthRequestHeader &bwRequestHdr)
{
...
void
WranUplinkSchedulerSimple::OnSetRequestedBandwidth (WranServiceFlowRecord *sfr)
{
