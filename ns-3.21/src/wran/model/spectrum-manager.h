...
public:
   ...
   */
	 ...
	 * Spectrum Manager initializer
	 */
	SpectrumManager(Ptr<WranNetDevice> wranNetDevice,
	 ...
	 */
	void SenseEnded(bool status, uint64_t frequency);
...
//	Ptr<RegularWifiMac> m_wifiMac;
	...
	Ptr<WranNetDevice> m_wranNetDevice;
//  // WranPhy reference
  Ptr<WranPhy> m_wranPhy;
