...
NS_LOG_COMPONENT_DEFINE ("WranIpcsClassifier");

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED (WranIpcsClassifier);

TypeId WranIpcsClassifier::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::WranIpcsClassifier")
    .SetParent<Object> ();
  return tid;
}

WranIpcsClassifier::WranIpcsClassifier (void)
{
}
...
WranServiceFlow *
WranIpcsClassifier::Classify (Ptr<const Packet> packet,
                          Ptr<WranServiceFlowManager> sfm, WranServiceFlow::Direction dir)
{
