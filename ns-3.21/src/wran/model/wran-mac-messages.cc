...
NS_LOG_COMPONENT_DEFINE ("WRANMACMESSAGES");

namespace ns3 {

NS_OBJECT_ENSURE_REGISTERED (WranManagementMessageType);

WranManagementMessageType::WranManagementMessageType (void)
  : m_type (~0)
{
}

WranManagementMessageType::WranManagementMessageType (uint8_t type)
  : m_type (type)
{
}
...
void
WranManagementMessageType::SetType (uint8_t type)
{
  m_type = type;
}

uint8_t
WranManagementMessageType::GetType (void) const
{
  return m_type;
}

std::string
WranManagementMessageType::GetName (void) const
{
  return "Management Message Type";
}

TypeId
WranManagementMessageType::GetTypeId (void)
{
  static TypeId tid =
    TypeId ("ns3::WranManagementMessageType").SetParent<Header> ().AddConstructor<WranManagementMessageType> ();
  return tid;
}

TypeId
WranManagementMessageType::GetInstanceTypeId (void) const
{
  return GetTypeId ();
}

void
WranManagementMessageType::Print (std::ostream &os) const
{
  os << " management message type = " << (uint32_t) m_type;
}

uint32_t
WranManagementMessageType::GetSerializedSize (void) const
{
  return 1;
}

void
WranManagementMessageType::Serialize (Buffer::Iterator start) const
{
...
uint32_t
WranManagementMessageType::Deserialize (Buffer::Iterator start)
{
  Buffer::Iterator i = start;
  m_type = i.ReadU8 ();
...
DsaReq::DsaReq (void)
  : m_transactionId (0),
    m_sfid (0),
    m_cid (),
    m_serviceFlow (WranServiceFlow::SF_DIRECTION_DOWN)
{
}

DsaReq::DsaReq (WranServiceFlow sf)
{
  m_transactionId = 0;
  m_serviceFlow = sf;
}
...
{
  WranTlv t = m_serviceFlow.ToWranTlv ();
...
DsaReq::Deserialize (Buffer::Iterator start)
{
  ...
  m_serviceFlow = WranServiceFlow (tlv);
  return size + 2;
}

WranServiceFlow
DsaReq::GetWranServiceFlow (void) const
{
  return m_serviceFlow;
}

void
DsaReq::SetWranServiceFlow (WranServiceFlow sf)
{
  m_serviceFlow = sf;
}
...
WranServiceFlow
DsaRsp::GetWranServiceFlow (void) const
{
  return m_serviceFlow;
}

void
DsaRsp::SetWranServiceFlow (WranServiceFlow sf)
{
  m_serviceFlow = sf;
}
...
{
  return 2 + 1 + m_serviceFlow.ToWranTlv ().GetSerializedSize ();
}
...
DsaRsp::Serialize (Buffer::Iterator start) const
{
  ...
  m_serviceFlow.ToWranTlv ().Serialize (i);
}
