 ...
 * \ingroup wran
 */
class WranBSLinkManager : public Object
{
public:
  static TypeId GetTypeId (void);
  WranBSLinkManager (Ptr<WranBaseStationNetDevice> bs);
  ~WranBSLinkManager (void);
  /**
...
private:
  WranBSLinkManager (const WranBSLinkManager &);
  WranBSLinkManager & operator= (const WranBSLinkManager &);
  ...
  void AbortRanging (Cid cid, RngRsp *rngrsp, WranSSRecord *ssRecord, bool isNewSS);
  void AcceptRanging (Cid cid, RngRsp *rngrsp, WranSSRecord *ssRecord);
  void ContinueRanging (Cid cid, RngRsp *rngrsp, WranSSRecord *ssRecord);
