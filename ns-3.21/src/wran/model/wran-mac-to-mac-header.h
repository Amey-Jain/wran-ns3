 ...
 *
 */
#ifndef WRAN_MAC_TO_MAC_HEADER_H
#define WRAN_MAC_TO_MAC_HEADER_H
...
/**
 * \ingroup wran
 * \brief this class implements the mac to mac header needed to dump a wran pcap file
 ...
 */
class WranMacToMacHeader : public Header
{
public:
  WranMacToMacHeader ();
  ~WranMacToMacHeader ();
  WranMacToMacHeader (uint32_t len);
