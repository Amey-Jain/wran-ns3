 ...
 */
class WranSSLinkManager : public Object
{
public:
  static TypeId GetTypeId (void);
  WranSSLinkManager (Ptr<WranSubscriberStationNetDevice> ss);
  ~WranSSLinkManager (void);
  void DoDispose (void);
  ...
  void StartScanning (WranSubscriberStationNetDevice::EventType type,
...
private:
  WranSSLinkManager (const WranSSLinkManager &);
  WranSSLinkManager & operator= (const WranSSLinkManager &);
