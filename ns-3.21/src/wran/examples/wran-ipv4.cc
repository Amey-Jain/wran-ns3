...
NS_LOG_COMPONENT_DEFINE ("wranIpV4Simulation");
  ...
  for (int i = 0; i < nbSS / 2; i++)
    {
      IpcsClassifierRecord DlClassifierBe (Ipv4Address ("0.0.0.0"),
                                           ...
                                           17,
                                           1);
      ServiceFlow DlServiceFlowBe = wran.CreateServiceFlow (ServiceFlow::SF_DIRECTION_DOWN,
      ...
      IpcsClassifierRecord ulClassifierBe (SSinterfaces.GetAddress (i + (nbSS / 2)),
                                           ...
                                           17,
                                           1);
      ServiceFlow ulServiceFlowBe = wran.CreateServiceFlow (ServiceFlow::SF_DIRECTION_UP,
                                                             ServiceFlow::SF_TYPE_BE,
                                                             ulClassifierBe);
