...
#ifndef WRAN_CHANNEL_H
#define WRAN_CHANNEL_H
 ...
 * \ingroup wran
 */
class WranChannel : public Channel
{
public:
  static TypeId GetTypeId (void);
  WranChannel (void);
  virtual ~WranChannel (void);
  /**
...
private:
  virtual void DoAttach (Ptr<WranPhy> phy) = 0;
