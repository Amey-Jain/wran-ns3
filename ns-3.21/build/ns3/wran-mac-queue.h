...
#ifndef WRAN_MAC_QUEUE_H
#define WRAN_MAC_QUEUE_H
 ...
 * \ingroup wran
 */
class WranMacQueue : public Object
{
public:
  static TypeId GetTypeId (void);
  WranMacQueue (void);
  WranMacQueue (uint32_t maxSize);
  ~WranMacQueue (void);
  /**
...
private:
  ...
  /*
   ...
   pops that elements.
   */
  WranMacQueue::QueueElement Front (MacHeaderType::HeaderType packetType) const;
...
public:
  const WranMacQueue::PacketQueue & GetPacketQueue (void) const;
};

} // namespace ns3

#endif /* WRAN_MAC_QUEUE_H */
