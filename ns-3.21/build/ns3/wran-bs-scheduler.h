 ...
 * \ingroup wran
 */
class WranBSScheduler : public Object
{
public:
  WranBSScheduler ();
  WranBSScheduler (Ptr<WranBaseStationNetDevice> bs);
  ~WranBSScheduler (void);
   ...
   */
  virtual void AddDownlinkBurst (Ptr<const WranConnection> connection,
                                 uint8_t diuc,
   ...
   */
  virtual bool SelectConnection (Ptr<WranConnection> &connection) = 0;
   ...
   */
  virtual Ptr<PacketBurst> CreateUgsBurst (WranServiceFlow *serviceFlow,
                                           WranPhy::ModulationType modulationType,
   ...
   */
  bool CheckForFragmentation (Ptr<WranConnection> connection,
