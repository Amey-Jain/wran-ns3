...
public:
  WranSSRecord (void);
  WranSSRecord (Mac48Address macAddress);
  WranSSRecord (Mac48Address macAddress, Ipv4Address IPaddress);
  ~WranSSRecord (void);
  ...
  void SetRangingStatus (WranNetDevice::RangingStatus rangingStatus);
  WranNetDevice::RangingStatus GetRangingStatus (void) const;
  ...
  bool GetHasWranServiceFlowUgs (void) const;
  bool GetHasWranServiceFlowRtps (void) const;
  bool GetHasWranServiceFlowNrtps (void) const;
  bool GetHasWranServiceFlowBe (void) const;
  ...
  void SetAreWranServiceFlowsAllocated (bool val);
private:
  ...
  WranPhy::ModulationType m_modulationType; // least robust burst profile (modulation type) for this SS
  WranNetDevice::RangingStatus m_rangingStatus;
