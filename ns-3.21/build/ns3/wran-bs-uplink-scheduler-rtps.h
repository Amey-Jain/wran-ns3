...
class WranUplinkSchedulerRtps : public WranUplinkScheduler
{
public:
  WranUplinkSchedulerRtps ();
  WranUplinkSchedulerRtps (Ptr<WranBaseStationNetDevice> bs);
  ~WranUplinkSchedulerRtps (void);
