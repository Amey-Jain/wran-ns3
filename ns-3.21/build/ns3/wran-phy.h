...
public:
   ...
   */
  Ptr<WranChannel> GetChannel (void) const;
  /**
   ...
   */
  void SetDevice (Ptr<WranNetDevice> device);
  /**
...
private:
  ...
  virtual void DoAttach (Ptr<WranChannel> channel) = 0;
