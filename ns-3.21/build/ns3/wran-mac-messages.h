 ...
 * \ingroup wran
 */
class WranManagementMessageType : public Header
{
public:
  /*
  ...
  WranManagementMessageType (void);
  WranManagementMessageType (uint8_t type);
  virtual ~WranManagementMessageType (void);
...
public:
   ...
   */
  void SetWranServiceFlow (WranServiceFlow sf);
  /**
